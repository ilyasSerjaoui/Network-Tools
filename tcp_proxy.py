...
def server_loop(local_host,local_port,remote_host,remote_port,receive_first):
    ...
    try:
        ...
        print("[!!] Check for other listen sockets or corerct permissions.")
        sys.exit(0)
    ...
    while True:
        ...
        print("[==>] Received income connection from %s:%d" % (addr[0],addr[1]))
...
def proxy_handler(client_socket,remote_host,remote_port,receive_first):
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            print("[==>] Receive %dd bytes from localhost." % len(localhost_buffer))
